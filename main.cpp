...
int main() {
    ...
    timmy->addAnimal(std::make_unique<Dog>("Old Yeller", "Golden retriever", 1950,
                                           Dog::Colour::Yellow,
                                           Dog::Marking::Merle));
    timmy->addAnimal(std::make_unique<Rabbit>(
            "Buggs", "Bunny", 1938, Rabbit::Colour::Gray, Rabbit::Marking::Solid));
    timmy->addAnimal(std::make_unique<Snake>(
    ...
    std::cout << std::endl << std::endl << "Hells yeah! Memory safe C++!!" << std::endl << "Fun smartpointer practice"
              << std::endl;
    return 0;
